...
<script setup lang="ts">
  ...
  const getStatistics = async () => {
    ...
    listSummary.value[3].total = handleFormatSummary(summary.totalBetPrize) as number
    listSummary.value[4].total = handleFormatSummary(summary.totalQuestPrize) as number
  }
