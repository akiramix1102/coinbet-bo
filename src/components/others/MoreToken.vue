<template>
  <el-popover v-model="isOpen" placement="bottom" popper-class="popper-token-more" width="200" trigger="click" class="p-2">
    <template #reference>
      <div class="px-3 py-4 cursor-pointer hover:text-tab-active" slot="reference">More...</div>
    </template>
    <div>
